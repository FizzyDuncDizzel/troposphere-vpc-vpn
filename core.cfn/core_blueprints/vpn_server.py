...
class CustomAmiLookup(AWSCustomObject):
...
class SubnetLookup(AWSCustomObject):
    resource_type = "Custom::SubnetLookup"
    props = {
        "ServiceToken": (str, True),
        "CoreVPCStack": (str, True),
        "Region": (str, True),
    }
...
class VpnServer(Blueprint):
    ...
    def add_resources(self):
        ...
        common_userdata_prefix = [
            ...
            "      set -e -o pipefail\n",
            "      \n",
            "      find . -name .rubocop.yml -exec rm -v {} \\;\n",
            "      chef-client -z -r '",
    ...
    def create_template(self):
        ...
        self.template.set_description("Sturdy Platform - Core - VPN Server - 1.0")
        self.add_conditions()
        self.add_resources()
